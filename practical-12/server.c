...
#define handle_thread_error(val, msg) if((val) < 0 ){ perror((msg)); pthread_exit(NULL); }
...
int main(int argc, char** argv)
{
	...
	pthread_t thread_handle; /* wird nur benötigt weil sich der compiler sonst beschwert */
    ...
    while(1)
    {
        ...
        */
        handle_error( 
            pthread_create(&thread_handle, &thread_attr, thread_function, (void*)&accept_socket),
            "thread starten"
        );
    }
