...
int main(int argc, char** argv)
{
    ...
    /* exithandler anmelden (sagt server tschüss, damit der datei schließen kann)*/
    atexit( exithandler );
    ...
    handle_error(
        read( sock_fd, &response, sizeof(struct server_response) ),
    ...
    do 
    {
        ...
        if(bytesRead == 0) break; /* stop falls dateiende! */
