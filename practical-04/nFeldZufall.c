...
int main(int argc, char** argv)
{
	...
	if(argc <= 1) 
	{
		fprintf(stderr, "Programm wird beendet, es muss genau 1 Parameter angegeben werden\n");
		return EXIT_FAILURE;	
	}
	...
	if (argWert <= 0)
	{
		fprintf(stderr, "Wert des eingegebenen Parameters muss groesser als O sein\n");
		return EXIT_FAILURE;	
	}
