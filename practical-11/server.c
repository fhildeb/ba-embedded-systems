    ...
    {	
        ...
        */
        ...
        /*
		    ...
		    Andere: Lesen (2)
		*/        
        destinationFileDescriptor = open( destinationFileInfo.name, 
        ...
        */
        ...
        /* 
		    ...
		    der Dateigröße        
        */
        if(ftruncate(destinationFileDescriptor, 
        destinationFileInfo.size) < 0 )
        {
        	// Status
        ...
        {	
            ...
            else if(conversation == TELL_DATA_PACKAGE)
            {
            	/*
            	    ...
            	    aktualisieren
            	*/
                bytesRead = read(clientSocket, &destinationData, 
                PACKAGE_SIZE);
				...
				bytesWritten = write(destinationFileDescriptor, 
				&destinationData, bytesRead);
                ...
                */
                ...
                // Status
                fprintf(stdout,"--Status: Packet %d gesendet "
