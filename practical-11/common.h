...
/*	Aufzählung aller "Handshake"-Stati numeriert von 0-5
	0 == Zieldatei erstellt bzw. Kopiervorgang beendet
	1 == Fehler beim Kopieren aufgetreten
	2 == Auf neue Dateiinfo zum Kopieren warten
	3 == Datenpacket wurde von Client gesendet
	4 == Verbindung trennen
*/
enum { TELL_SUCCESS, TELL_ERROR, TELL_INFO, TELL_DATA_PACKAGE, TELL_BYE };
