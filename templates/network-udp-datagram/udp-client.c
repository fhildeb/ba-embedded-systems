...
int main(int argc, char *argv[])
{
   ...
   *  Anleitung  */
  if (recvfrom(s, line, sizeof(line), 0, NULL, NULL) < 0)
  { /* 1.Zeile = 1.Datagramm lesen */
    perror("recvfrom 1");
    exit(EXIT_FAILURE);
  }
  puts(line); /* anzeigen */
  ...
  { /* solange nicht ENDE\n  */
    if (sendto(s, line, sizeof(line), 0, (struct sockaddr *)&sin, sizeof(sin)) <
        0)
    {
