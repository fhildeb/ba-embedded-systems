...
const char *datenTypen[] = {"regular file", "directory", "character device",
                            "block device", "FIFO",      "symbolic link",
                            "socket"};
...
und in String umwandeln*/
  ...
  -NAMEN		-Gerätenummer		-i-Node-Nummer
  -Linkzähler -Dateityp	-Zugriffsrechte	-Besitzer			-Gruppe
  ...
  */
  void showStats(char *input_name)
  {
    ...
    printf("_______Gruppeninformationen: %s: %d\n", gruppenInformation->gr_name,
           eigenschaften.st_gid);
  ...
  // Datei ist Verzeichnis
  {
    ...
    printf("Datei ist Verzeichnis mit folgenden Dateien und dessen "
           "Eigenschaften:\n");
