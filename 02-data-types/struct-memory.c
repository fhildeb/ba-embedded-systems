...
int main()
{
  ...
  printf("        Die Datenstruktur speichert die Datentypen in 4 Byte "
         "Adressen ab. Unterschiedliche \n"
         "        aufeinanderfolgende Datentypen beginnen jedoch mit neunen "
         "Byte. Fuellt der vorherige \n"
         "        Datentyp den Platz von 4 Byte nicht aus, so bleibt dieser "
         "Speicher frei.\n");
  printf("        Die Variable 'component' der Strucktur 'test' belegt somit "
         "insgesamt %d Byte. \n"
